...
public class WaxingServiceFragment extends Fragment implements ServiceAdapter.OnItemClickListener{
    ...
    private void setRecyclerView_service() {
        ...
        waxingViewModel.getItemsService().observe(getViewLifecycleOwner(), serviceAdapter::submitList);
    }
    @Override
